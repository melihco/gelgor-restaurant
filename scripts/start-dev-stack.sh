...
echo "  Worker    production-slots (BullMQ — REQUIRED for feed when PRODUCTION_EXECUTOR=bullmq)"
echo ""
echo "Worker yoksa enqueue 503 production_worker_offline döner (job'lar running'de kilitlenmez)."
echo "Tek başına Next için: cd apps/web && npm run dev:with-worker"
