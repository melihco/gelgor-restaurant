...
def build_service_env(merged: dict[str, str]) -> dict[str, dict[str, str]]:
    ...
    web_env = {
        **shared,
        ...
        "GRAFIKER_LITE": merged.get("GRAFIKER_LITE", "false"),
        "CD_LITE": merged.get("CD_LITE", "true"),
        "AD_REUSE_DESIGNED_POST_STILL": merged.get("AD_REUSE_DESIGNED_POST_STILL", "true"),
        "CAROUSEL_HERO_ENHANCE_ONLY": merged.get("CAROUSEL_HERO_ENHANCE_ONLY", "true"),
        ...
        "AUTO_PRODUCE_GALLERY_ONLY": merged.get("AUTO_PRODUCE_GALLERY_ONLY", "true"),
        ...
        "AUTO_PRODUCE_BYPASS_LIMITS": merged.get("AUTO_PRODUCE_BYPASS_LIMITS", "false"),
