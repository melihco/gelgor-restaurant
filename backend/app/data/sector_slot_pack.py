...
_SECTOR_SLOT_PACKS_BASE: list[SectorPack] = [
    ...
    },
    {
        ...
        "instances": [
            ...
            _inst("happy_hour_post", "Happy hour", "Happy hour", "post", ["requires:bar"]),
            ...
            _inst("cocktail_bar_reel", "Kokteyl bar reel", "Cocktail bar reel", "reel", ["requires:bar"]),
    ...
    },
    {
        ...
        "instances": [
            ...
            _inst("happy_hour_story", "Happy hour story", "Happy hour story", "story", ["requires:bar"]),
    ...
    {
        "sector_id": "kids_party_venue",
        "label_tr": "Çocuk Parti Evi",
        "label_en": "Kids Party Venue",
        "aliases": [
            "kids_party",
            "kids_birthday",
        ...
        "instances": [
            _inst("venue_showcase_post", "Mekan vitrin", "Venue showcase", "post"),
            _inst("theme_room_post", "Tema oda", "Theme room", "post", ["requires:kids_area"]),
            _inst("birthday_package_post", "Doğum günü paketi", "Birthday package", "post"),
            _inst("cake_table_post", "Pasta masası", "Cake table", "post"),
            _inst("activity_zone_post", "Aktivite alanı", "Activity zone", "post", ["requires:kids_area"]),
            _inst("character_theme_post", "Karakter teması", "Character theme", "post"),
            _inst("decoration_detail_post", "Süsleme detay", "Decoration detail", "post"),
            _inst("parent_testimonial_post", "Ebeveyn yorumu", "Parent testimonial", "post"),
            _inst("weekend_availability_post", "Hafta sonu müsaitlik", "Weekend availability", "post"),
            _inst("private_party_post", "Özel parti", "Private party", "post", ["requires:private_events"]),
            _inst("party_invite_story", "Parti daveti story", "Party invite story", "story"),
            _inst("decoration_bts_story", "Süsleme kulis story", "Decoration BTS story", "story"),
            _inst("booking_cta_story", "Rezervasyon CTA story", "Booking CTA story", "story"),
            _inst(
                "event_announcement_story",
                "Parti duyuru afişi",
                "Party announcement story",
                "story",
                pipeline="fal_story",
                slot_role="campaign_story_motion",
                design_template_type="event_special",
            ...
            _inst("party_highlights_reel", "Parti highlight reel", "Party highlights reel", "reel"),
            _inst("venue_walkthrough_reel", "Mekan walkthrough reel", "Venue walkthrough reel", "reel"),
            _inst("kids_activity_reel", "Çocuk aktivite reel", "Kids activity reel", "reel", ["requires:kids_area"]),
            _inst("package_options_carousel", "Paket seçenekleri carousel", "Package options carousel", "carousel"),
        ],
    },
    {
