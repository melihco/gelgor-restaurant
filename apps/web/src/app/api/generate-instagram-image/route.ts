...
function buildReferenceEditDirective(
  ...
  if (isDesignCard && isVideoReel) {
    return compactLines([
      ...
      'If an official brand logo is configured, follow BRAND LOGO CONTRACT — keep that corner calm with the photograph continuing as-is and paint no plate or placeholder; the exact logo file is composited after generation. Do NOT draw or reinterpret the mark.',
      '',
