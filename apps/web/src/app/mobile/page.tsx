...
const CSS = `
  ...
  .sa-mobile .visual-font-grid {
    display: grid;
    grid-template-columns: 1fr 1fr;
    gap: 8px;
  }
  .sa-mobile .visual-font-chip {
    display: flex;
    align-items: center;
    gap: 8px;
    min-height: 52px;
  ...
  .sa-mobile .visual-font-chip__meta {
    min-width: 0;
    display: flex;
    flex-direction: column;
    gap: 1px;
  }
  .sa-mobile .visual-font-chip__title {
    font-size: 12px;
    font-weight: 700;
    line-height: 1.2;
  }
  .sa-mobile .visual-font-chip__desc {
    font-size: 10px;
    color: rgba(148,163,184,0.65);
    line-height: 1.3;
  }
  .sa-mobile .visual-ref-row {
    display: flex;
    flex-wrap: wrap;
    gap: 8px;
    margin-top: 8px;
  }
  .sa-mobile .visual-ref-thumb,
  .sa-mobile .visual-ref-add {
    width: 56px;
    height: 56px;
    border-radius: 12px;
    overflow: hidden;
  ...
  .sa-mobile .visual-ref-thumb img {
    width: 100%;
    height: 100%;
    object-fit: cover;
  }
