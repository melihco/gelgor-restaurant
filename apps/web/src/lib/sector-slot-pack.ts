...
const SECTOR_SLOT_PACKS_BASE: SectorSlotPack[] = [
  ...
  },
  {
    ...
    labelTr: 'Çocuk Parti Evi',
    labelEn: 'Kids Party Venue',
    aliases: [
      'kids_party',
      'kids_birthday',
      'birthday_party_house',
      'party_house',
      'children_party_venue',
      'cocuk_parti_evi',
      'dogum_gunu_evi',
      'kids_party_service',
    ],
    ...
    instances: [
      { suffix: 'venue_showcase_post', labelTr: 'Mekan vitrin', labelEn: 'Venue showcase', format: 'post' },
      { suffix: 'theme_room_post', labelTr: 'Tema oda', labelEn: 'Theme room', format: 'post', optionalTags: ['requires:kids_area'] },
      { suffix: 'birthday_package_post', labelTr: 'Doğum günü paketi', labelEn: 'Birthday package', format: 'post' },
      { suffix: 'cake_table_post', labelTr: 'Pasta masası', labelEn: 'Cake table', format: 'post' },
      { suffix: 'activity_zone_post', labelTr: 'Aktivite alanı', labelEn: 'Activity zone', format: 'post', optionalTags: ['requires:kids_area'] },
      { suffix: 'character_theme_post', labelTr: 'Karakter teması', labelEn: 'Character theme', format: 'post' },
      { suffix: 'decoration_detail_post', labelTr: 'Süsleme detay', labelEn: 'Decoration detail', format: 'post' },
      { suffix: 'parent_testimonial_post', labelTr: 'Ebeveyn yorumu', labelEn: 'Parent testimonial', format: 'post' },
      { suffix: 'weekend_availability_post', labelTr: 'Hafta sonu müsaitlik', labelEn: 'Weekend availability', format: 'post' },
      { suffix: 'private_party_post', labelTr: 'Özel parti', labelEn: 'Private party', format: 'post', optionalTags: ['requires:private_events'] },
      { suffix: 'party_invite_story', labelTr: 'Parti daveti story', labelEn: 'Party invite story', format: 'story' },
      { suffix: 'decoration_bts_story', labelTr: 'Süsleme kulis story', labelEn: 'Decoration BTS story', format: 'story' },
      { suffix: 'booking_cta_story', labelTr: 'Rezervasyon CTA story', labelEn: 'Booking CTA story', format: 'story' },
      {
        suffix: 'event_announcement_story',
        labelTr: 'Parti duyuru afişi',
        labelEn: 'Party announcement story',
        format: 'story',
        pipeline: 'fal_story',
        slotRole: 'campaign_story_motion',
        designTemplateType: 'event_special',
      ...
      { suffix: 'party_highlights_reel', labelTr: 'Parti highlight reel', labelEn: 'Party highlights reel', format: 'reel' },
      { suffix: 'venue_walkthrough_reel', labelTr: 'Mekan walkthrough reel', labelEn: 'Venue walkthrough reel', format: 'reel' },
      { suffix: 'kids_activity_reel', labelTr: 'Çocuk aktivite reel', labelEn: 'Kids activity reel', format: 'reel', optionalTags: ['requires:kids_area'] },
      { suffix: 'package_options_carousel', labelTr: 'Paket seçenekleri carousel', labelEn: 'Package options carousel', format: 'carousel' },
    ],
  },
  {
