    ...
    public static async Task SeedAsync(NexusDbContext context)
    {
        ...
        var packages = new List<PackageDefinition>
        {
            new()
            {
                ...
                Features = "[\"14 misyon/ay\",\"168 organik içerik + 56 reel\",\"14 Meta + 14 Google reklam\",\"5.000 SA Kredi\",\"40 galeri analizi\",\"Yorum yanıtlama\",\"E-posta destek\"]",
                SortOrder = 1,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"28 misyon/ay\",\"336 organik içerik + 112 reel\",\"28 Meta + 28 Google reklam\",\"15.000 SA Kredi\",\"120 galeri analizi\",\"Blog + SEO\"]",
                SortOrder = 2,
                IsActive = true,
                IsPopular = true,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"65 misyon/ay\",\"780 organik içerik + 260 reel\",\"65 Meta + 65 Google reklam\",\"40.000 SA Kredi\",\"250 galeri analizi\",\"Growth Recovery\"]",
                SortOrder = 3,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
