    ...
    public static async Task SeedAsync(NexusDbContext context)
    {
        ...
        var packages = new List<PackageDefinition>
        {
            new()
            {
                ...
                Features = "[\"14 misyon/ay\",\"98 organik içerik\",\"14 Meta + 14 Google reklam\",\"5.000 SA Kredi\",\"40 galeri analizi\",\"Yorum yanıtlama\",\"E-posta destek\"]",
                SortOrder = 1,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"28 misyon/ay\",\"196 sosyal içerik\",\"15.000 SA Kredi\",\"120 galeri analizi\",\"4 reel\",\"Blog + SEO\"]",
                SortOrder = 2,
                IsActive = true,
                IsPopular = true,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"65 misyon/ay\",\"455 sosyal içerik\",\"40.000 SA Kredi\",\"250 galeri analizi\",\"8 Runway reel\",\"Growth Recovery\"]",
                SortOrder = 3,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
