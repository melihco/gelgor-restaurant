    ...
    public static async Task SeedAsync(NexusDbContext context)
    {
        ...
        var packages = new List<PackageDefinition>
        {
            new()
            {
                ...
                Features = "[\"8 misyon/ay\",\"~96 içerik + 8 reel\",\"4 Meta + 4 Google reklam\",\"5.000 SA Kredi\",\"40 galeri analizi\",\"Yorum yanıtlama\",\"E-posta destek\"]",
                SortOrder = 1,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                MonthlyPrice = 11990m,
                YearlyPrice = 119900m,
                TaskLimitPerMonth = 16,
                IncludedAgentTypes = "[\"CustomerReviewResponder\",\"ContentStrategy\",\"InstagramContentGenerator\",\"BlogWriter\",\"SeoSpecialist\"]",
                Features = "[\"16 misyon/ay\",\"~256 içerik + 16 reel\",\"16 Meta + 16 Google reklam\",\"15.000 SA Kredi\",\"120 galeri analizi\",\"Blog + SEO\"]",
                SortOrder = 2,
                IsActive = true,
                IsPopular = true,
                CreatedBy = userId,
