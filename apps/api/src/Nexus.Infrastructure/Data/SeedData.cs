    ...
    public static async Task SeedAsync(NexusDbContext context)
    {
        ...
        var packages = new List<PackageDefinition>
        {
            new()
            {
                ...
                MonthlyPrice = 4992m,
                YearlyPrice = 49920m,
                TaskLimitPerMonth = 14,
                IncludedAgentTypes = "[\"CustomerReviewResponder\",\"ContentStrategy\",\"InstagramContentGenerator\"]",
                Features = "[\"14 misyon/ay\",\"~140 içerik + 14 reel\",\"14 Meta + 14 Google reklam\",\"5.000 SA Kredi\",\"40 galeri analizi\",\"Yorum yanıtlama\",\"E-posta destek\"]",
                SortOrder = 1,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                MonthlyPrice = 9984m,
                YearlyPrice = 99840m,
                TaskLimitPerMonth = 28,
                IncludedAgentTypes = "[\"CustomerReviewResponder\",\"ContentStrategy\",\"InstagramContentGenerator\",\"BlogWriter\",\"SeoSpecialist\"]",
                Features = "[\"28 misyon/ay\",\"~280 içerik + 28 reel\",\"28 Meta + 28 Google reklam\",\"15.000 SA Kredi\",\"120 galeri analizi\",\"Blog + SEO\"]",
                SortOrder = 2,
                IsActive = true,
                IsPopular = true,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"65 misyon/ay\",\"~650 içerik + 65 reel\",\"65 Meta + 65 Google reklam\",\"40.000 SA Kredi\",\"250 galeri analizi\",\"Growth Recovery\"]",
                SortOrder = 3,
                // Retired from catalog — keep row for existing subscriptions
                IsActive = false,
                IsPopular = false,
                CreatedBy = userId,
                UpdatedBy = userId
            ...
            new()
            {
                ...
                Features = "[\"Sınırsız misyon & içerik\",\"150.000 SA Kredi\",\"Tüm agentlar\",\"AI CEO\",\"Öncelikli destek\"]",
                SortOrder = 4,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
