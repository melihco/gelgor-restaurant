    ...
    public static async Task SeedAsync(NexusDbContext context)
    {
        ...
        var packages = new List<PackageDefinition>
        {
            new()
            {
                ...
                MonthlyPrice = 4900m,
                YearlyPrice = 49000m,
                TaskLimitPerMonth = 100,
                IncludedAgentTypes = "[\"CustomerReviewResponder\",\"ContentStrategy\",\"InstagramContentGenerator\"]",
                Features = "[\"Yorum yanıtlama\",\"Instagram içerik planı\",\"Temel raporlama\",\"E-posta destek\"]",
                SortOrder = 1,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"Growth özellikleri\",\"Growth Recovery workflow\",\"Google Ads analizi\",\"Sosyal medya tasarım\",\"Video içerik\",\"UI/UX önerisi\",\"Yüksek görev limiti\"]",
                SortOrder = 3,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
            ...
            new()
            {
                ...
                Features = "[\"Tüm agentlar\",\"AI CEO koordinasyonu\",\"Strateji planlama\",\"Gelişmiş raporlama\",\"Öncelikli execution\",\"Dedicated destek\"]",
                SortOrder = 4,
                IsActive = true,
                IsPopular = false,
                CreatedBy = userId,
